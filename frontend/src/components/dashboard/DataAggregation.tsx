    ...
    <Card>
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          {aggregationState.clickedMetrics.length > 0 && aggregationState.clickedDimensions.length === 0 && (
            <div className="text-sm text-amber-600 bg-amber-50 p-3 rounded-lg border border-amber-200">
              <div className="flex items-center gap-2">
                ...
                <span>Select at least one dimension (like "campaign" or "country") for better aggregation results.</span>
              </div>
            </div>
          )}
